...
template <> constexpr inline auto WindowManager::qt_create_metaobjectdata<qt_meta_tag_ZN13WindowManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::MethodData<void(int, int)>(15, 6, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 16 }, { QMetaType::Int, 17 },
        }}),
        // Method 'toggleTiling'
        QtMocHelpers::MethodData<void()>(18, 6, QMC::AccessPublic, QMetaType::Void),
        // Method 'setStrut'
        QtMocHelpers::MethodData<void(int, int, int, int)>(19, 6, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 20 }, { QMetaType::Int, 21 }, { QMetaType::Int, 22 }, { QMetaType::Int, 23 },
        }}),
    };
    QtMocHelpers::UintData qt_properties {
        ...
        QtMocHelpers::PropertyData<MonitorManager*>(29, 0x80000000 | 30, QMC::DefaultPropertyFlags | QMC::EnumOrFlag | QMC::Constant),
    };
...
void WindowManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->minimize((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->switchToWorkspace((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->moveWindowToWorkspace((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 8: _t->toggleTiling(); break;
        case 9: _t->setStrut((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[4]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (WindowManager::*)()>(_a, &WindowManager::currentWorkspaceChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (WindowManager::*)()>(_a, &WindowManager::tilingChanged, 2))
            return;
    }
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 3: *reinterpret_cast<bool*>(_v) = _t->isTiling(); break;
        case 4: *reinterpret_cast<MonitorManager**>(_v) = _t->monitorManager(); break;
        default: break;
        }
    }
...
// SIGNAL 2
void WindowManager::tilingChanged()
{
